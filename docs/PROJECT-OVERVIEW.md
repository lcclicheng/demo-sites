...
| 建站 upsell | £590 一次 + 首月代改 | 信任建立后自然升级 |
| Care + AI 接待 | £390/年起 | 抬客单价、锁续费 |

**阶梯**：免费样例 → £29/月（信任+现金流）→ 1–2 月后 upsell £590 建站（A）→ £390/年 Care(+AI 接待)。当前仅资产并入 + 文档同步；**未上线落地页、未改 Day1 外联钩子**（3 待定项：产品名 / 首发垂直+城市 / 首档）。
