...
- 是否收费：按你定价（纯订阅 v2：Free £0 评价草稿 / Reputation £39/mo 声誉管理 / Growth Partner £79/mo 含免费建站 + 托管 + 更新 + 基础 SEO / Growth Plus £149/mo 高阶，见 `docs/pricing.md` v2）。首触用「免费 3 条评价回复草稿」作钩子，转化后再走正式订阅。
