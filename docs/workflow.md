...
| **v0.9.2** | 2026-07-14 | **定价两档落地（进攻型）**：建站含 CMS 自助 £590 一次性 / 年度呵护 £390/年，作为初始报价基准（首客交付后复盘重定），见 `docs/pricing.md`；**2026-07-15 增补分行业三档微调**（law/hotel 高、trades 经济、其余标准，±£50/±£40），见 pricing.md「分行业定价调整」 |
...
| 定价两档（建站含 CMS 自助 £590 一次性 / 年度呵护 £390 年，含**分行业三档微调**：law/hotel 上浮、trades 下浮，幅度 ±£50/±£40） | 低/中 | ✅ 已落地（v0.9.2 两档基准；2026-07-15 增补分行业三档微调，见 `docs/pricing.md`「分行业定价调整」；首客交付后复盘重定） | v0.9.2 | 你（定价）/ AI（文档） |
