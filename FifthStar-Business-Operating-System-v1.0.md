...
一人公司 **lcclicheng**，对外 **Ethan Li**（lic28790@gmail.com）。给英国本地实体商家（餐厅/咖啡/沙龙/律所/瑜伽/家装/酒店）做 **AI Google 评价回复 + 声誉监测 + 高端建站**，用「免费 3 条评价回复」拿下零客户与现金流，再 upsell 到 **£79/mo Growth（含免费建站）订阅**——建站不再收一次性费，收入来自持续订阅（纯订阅制，见 `docs/pricing.md` / `metrics/pure-subscription-model.md`）。
...
> ✅ **定价已升级为纯订阅制（2026-07-24）**：取消一次性 £590 建站与 £390/年 Care；改为 **Free(£0) → Starter(£29/mo) → Growth(£79/mo，无站商家免费建站作楔子)**。旧 `£149/mo` / `£590` / `£390/yr` 全部废弃。单位经济模型见 `metrics/pure-subscription-model.md`，定价细则见 `docs/pricing.md`。`AGENT-ONBOARDING.md` §4.1 已同步。
...
- **A/B 分叉后移**：有无官网的分叉移到**回信后**跟进阶段——A=无站→**£79/mo Growth（免费建站楔子）**；B=有站→£29/£79 订阅 + widget。
...
- 目标：订阅续费率 ≥85%、月 Churn ≤5%、Starter→Growth 升档交叉销售 ≥40%。
...
| 风险 | 影响 | 缓解 |
|---|---|---|
| 定价冲突（已解决） | 纯订阅制已统一（Free→£29→£79 含免费建站），取消 £590/£390 | — |
