...
一人公司 **lcclicheng**，对外 **Ethan Li**（lic28790@gmail.com）。给英国本地实体商家（餐厅/咖啡/沙龙/律所/瑜伽/家装/酒店）做 **AI Google 评价回复 + 声誉监测 + 高端建站**，用「免费 3 条评价回复」拿下零客户与现金流，再 upsell 到 **£39/mo Reputation（声誉托管）/ £79/mo Growth Partner（含免费建站，Most Popular）/ £149/mo Growth Plus（高阶增长）** 四档订阅——建站不再收一次性费，收入来自持续订阅（纯订阅制 v2，见 `docs/pricing.md` v2 / `metrics/pure-subscription-model.md` v2）。对外讲 "Build your online presence without upfront website costs" / "Your reputation, website and local growth — managed in one place"，**不作** "Free website — £79/mo"。
...
> ✅ **定价已升级为纯订阅制 v2（2026-07-24 Pricing v2）**：取消一次性 £590 建站与 £390/年 Care；改为 **Free(£0) → Reputation(£39/mo) → Growth Partner(£79/mo，无站商家免费建站作楔子，Most Popular) → Growth Plus(£149/mo，接住高端溢出需求)**。Starter 提价改名 Reputation（去小工具感），Growth 改名 Growth Partner（避"网站租赁"感），新增 Growth Plus（SEO 内容 + 更多更新 + 优先支持）。免费建站交付边界：template-based / ≤5 pages / 1 revision·月 / 7 天标准交付，超出收费。单位经济模型见 `metrics/pure-subscription-model.md` v2（含保守 Churn 100→70→50→40 与 NRR），定价细则见 `docs/pricing.md` v2。
...
- **A/B 分叉后移**：有无官网的分叉移到**回信后**跟进阶段——A=无站→**£79/mo Growth Partner（免费建站楔子）**；B=有站→£39 Reputation / £79 Growth Partner / £149 Growth Plus 订阅 + widget（按需求升档）。
...
- **谈判原则**：不绑死长期、涨价透明、订阅价值强调省心（站免费建，只管月付）。
- **流失挽回**：at_risk 信号 → 人工 1 对 1，目标挽回 ≥30% 退订意向。
- 目标：订阅续费率 ≥85%、月 Churn ≤5%、Reputation→Growth Partner→Growth Plus 扩档（NRR 引擎）交叉销售 ≥40%；年化 churn 规划底线 ≤50%（见 `metrics/pure-subscription-model.md` v2 §4）。
...
| 风险 | 影响 | 缓解 |
|---|---|---|
| 定价冲突（已解决 v2） | 纯订阅制 v2 已统一（Free→£39 Reputation→£79 Growth Partner→£149 Growth Plus 含免费建站），取消 £590/£390 | 增 NRR / 交付边界防时间崩盘 |
