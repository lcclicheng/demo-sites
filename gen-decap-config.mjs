...
# 媒体库根级目录（Decap schema 强制要求 media_folder；本项目不启用图片上传组件，
# 故不声明 media_library —— 声明会被当成「外部媒体库」要求 CMS.registerMediaLibrary 注册，
# 反而会报 Missing external media library。省略 media_library 时 Decap 自动用内置默认库）
