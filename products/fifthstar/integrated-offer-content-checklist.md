...
- 定价（纯订阅制 v2 · 2026-07-24 Pricing v2）：Free £0（评价草稿）/ Reputation £39·mo / Growth Partner £79·mo（Most Popular，含免费建站 + 托管 + 更新 + 基础 SEO）/ Growth Plus £149·mo（高阶）—— 见 `docs/pricing.md` v2 / `metrics/pure-subscription-model.md` v2。免费建站交付边界：template-based / ≤5 pages / 1 revision·月 / 7 天。旧 £590/£390/£980 已废弃。
