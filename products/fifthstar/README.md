...
- **轨 A · FifthStar（战略主线 / 冷启动楔子）**：用 940 家曼城独立餐厅线索（本地 CSV，不进公开仓），钩子=免费 3 条评价回复样例 → £39/月 Reputation → £79/月 Growth Partner（含免费建站 + 托管 + 更新 + 基础 SEO，Most Popular）→ £149/月 Growth Plus（高阶）。城市饱和打法：Manchester→Birmingham→Leeds→Bristol→Liverpool→Edinburgh。
