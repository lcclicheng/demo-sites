...
And the rule still stands: I do the work first, you only pay once you're happy
with it. Cancel anytime — if a month's not right, tell me and the next one's
not charged.

Want me to fire the first invoice over so you can see how it feels?
...
## D. 商户问"安全吗 / 你们收什么卡？"（付款方式 reassurance）
...
Totally fair question. Two things:

1) Payment goes through PayPal — you pay with any UK Visa/Mastercard or your
   PayPal balance, no account needed, and I never touch your card number.
   PayPal's the one holding the details, not me.

2) You only pay after you've seen the work and liked it. If anything's off in
   a paid month, tell me and it's not charged again — or refunded, your call.

No surprises, no lock-in. The free drafts are yours regardless.
...
> 注：本模板与 `integrated-offer.html` 的 "How you pay" 段、框架文档 §6 统一 P.S. 保持一致。真实发送需 `SMTP_PASS`；账单走 PayPal 中国账户邮件发票。
