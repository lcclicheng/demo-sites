...
- **Track A（无官网）**：首触统一钩子 → 回信后切 **£79/mo Growth（免费建站楔子）**。付费率目标 ≥ 8%（订阅高价值、低量）。
...
| Free | £0 | £0 | £0 | 样例已发 |
| Starter | £29/mo | £29 | — | 0 |
| Growth | £79/mo（含免费建站） | £79 | — | 0 |

- **MRR 目标（验证期 90 天）**：≥ £300/mo（约 4×Starter 或 2×Growth 或混合）。
...
- 6 家 P0x（Track A，预计首单 £79/mo Growth，年化 £948）→ 管道基线 ≈ 6 × £948 × 0.3(合格概率) ≈ **£1,706**。
